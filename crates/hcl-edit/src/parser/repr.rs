...
pub(super) fn spanned<'a, F, O>(inner: F) -> impl Parser<Input<'a>, O, ContextError<Input<'a>>>
where
    F: Parser<Input<'a>, O, ContextError<Input<'a>>>,
    O: SetSpan,
{
...
pub(super) fn decorated<'a, F, G, H, O1, O2, O3>(
    ...
    inner: G,
    suffix: H,
) -> impl Parser<Input<'a>, O2, ContextError<Input<'a>>>
where
    F: Parser<Input<'a>, O1, ContextError<Input<'a>>>,
    G: Parser<Input<'a>, O2, ContextError<Input<'a>>>,
    H: Parser<Input<'a>, O3, ContextError<Input<'a>>>,
    O2: Decorate + SetSpan,
{
...
pub(super) fn suffix_decorated<'a, F, G, O1, O2>(
    inner: F,
    suffix: G,
) -> impl Parser<Input<'a>, O1, ContextError<Input<'a>>>
where
    F: Parser<Input<'a>, O1, ContextError<Input<'a>>>,
    G: Parser<Input<'a>, O2, ContextError<Input<'a>>>,
    O1: Decorate + SetSpan,
