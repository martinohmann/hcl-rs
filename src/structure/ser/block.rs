use super::{
    BodySerializer, ExpressionSerializer, IdentifierSerializer, SeqSerializer, StringSerializer,
    StructureSerializer,
};
...
impl ser::Serializer for BlockSerializer {
    ...
    fn serialize_some<T>(self, value: &T) -> Result<Block>
    where
        T: ?Sized + Serialize,
    {
    ...
    fn serialize_newtype_struct<T>(self, _name: &'static str, value: &T) -> Result<Block>
    where
        T: ?Sized + Serialize,
    {
        value.serialize(self)
